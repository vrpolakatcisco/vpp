...
Library           Collections
Library           SSHLibrary
Resource          ${CURDIR}/ContainerConnections.robot
...
Open_Single_Container_Connection_And_Store_Ip_For_Type
    ...
    BuiltIn.Run_Keyword    ContainerConnections.Open_New_Bash_Container_Connection    ${type}    ${pod_name}    prompt=\#
...
Open_Multiple_Container_Connections_And_Store_Ips_For_Type
    ...
    \    BuiltIn.Run_Keyword    ContainerConnections.Open_New_Bash_Container_Connection    ${type}_${index}    ${pod_name}    prompt=\#
    \    ${pod_details} =     PodManagement.Describe_Pod    ${pod_name}
    \    ${ip} =     BuiltIn.Evaluate    &{pod_details}[${pod_name}]["IP"]
...
Close_Single_Container_Connection_For_Type
    ...
    ContainerConnections.Close_Active_Container_Connection
