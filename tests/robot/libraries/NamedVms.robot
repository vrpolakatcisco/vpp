...
Get_Cluster_Max_Size
    ...
    ...    This returns number of possibly available hosts.
...
Switch_To_Node_For_Index
    [Arguments]    ${index}
    [Documentation]    Get alias for the index, switch there.
...
Get_Machine_Status
    [Arguments]    ${alias}
    [Documentation]    Execute df, free, ifconfig -a, ps -aux... on active connection.
