...
Append_Command_Log
    ...
    ${output_size} =    BuiltIn.Get_Length    ${output}
    ${if_output} =    BuiltIn.Set_Variable_If    ${output_size}    ${output}${\n}    ${EMPTY}
    ${stderr_size} =    Builtin.Get_Length    ${stderr}
    ${if_stderr} =    BuiltIn.Set_Variable_If    ${stderr_size}    *** Stderr: ${stderr}${\n}    ${EMPTY}
